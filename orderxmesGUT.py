...
file_name_excel = "C:\Proyectos\Vtex APIs\listado_ordenes_GUT_" + ini_prev_month.strftime("%Y%m%d") + "_" + end_prev_month.strftime("%Y%m%d") + ".xlsx"
...
urllistord = "https://bathbodygt.myvtex.com/api/oms/pvt/orders?per_page=100&page="
urlord = "https://bathbodygt.myvtex.com/api/oms/pvt/orders"
...
headers = {
    ...
    'X-VTEX-API-AppKey' : "vtexappkey-bathbodygt-SCDMPS",
    'X-VTEX-API-AppToken' : "FEVWBUFBKLMQSHCERHXOKSWZBFBKHELJWTHPTLWQGFLDUCPHIEUZUUANIWVWSUUFZCUZZMKFLHHFGSFYQUCCJMOBSUHXQZXLLGDRHPHVTPONMUGPQXGYRRVNNSGFFNPL"
    }
