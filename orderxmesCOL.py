...
file_name_excel = "C:\Proyectos\Vtex APIs\listado_ordenes_COL_" + ini_prev_month.strftime("%Y%m%d") + "_" + end_prev_month.strftime("%Y%m%d") + ".xlsx"
...
urllistord = "https://bathbodyco.myvtex.com/api/oms/pvt/orders?per_page=100&page="
urlord = "https://bathbodyco.myvtex.com/api/oms/pvt/orders"
